...
const Button = ({ semanticRole, aiMetadata, action = 'primary', context = 'form', children, ...props }) => {
    ...
    return (jsxRuntimeExports.jsx(reactCore.Button, { ...props, "data-semantic-role": role, "data-ai-metadata": JSON.stringify(metadata), "data-action": action, "data-context": context, children: children }));
};
...
const Card = ({ semanticRole, aiMetadata, purpose = 'content-display', contentType = 'mixed', children, ...props }) => {
    ...
    return (jsxRuntimeExports.jsx(reactCore.Card, { ...props, "data-semantic-role": role, "data-ai-metadata": JSON.stringify(metadata), "data-purpose": purpose, "data-content-type": contentType, children: children }));
};
...
const Modal = require$$0.forwardRef(({ semanticRole, aiMetadata, purpose = 'information', interactionType = 'blocking', children, ...props }, ref) => {
    ...
    return (jsxRuntimeExports.jsx(reactCore.Modal, { ...props, ref: ref, "data-semantic-role": role, "data-ai-metadata": JSON.stringify(metadata), "data-purpose": purpose, "data-interaction-type": interactionType, children: children }));
});
...
const useSemanticMetadata = (componentName, userMetadata, props = {}) => {
    const [metadata, setMetadata] = require$$0.useState(() => {
...
const useAccessibility = (componentType, props = {}, context = {}) => {
    const ariaAttributes = require$$0.useMemo(() => generateAriaAttributes(componentType), [componentType]);
    const keyboardShortcuts = require$$0.useMemo(() => generateKeyboardShortcuts(componentType, context), [componentType, context]);
    const accessibilityIssues = require$$0.useMemo(() => validateAccessibility(componentType, props), [componentType, props]);
    const enhancedProps = require$$0.useMemo(() => ({
        ...props,
        ...ariaAttributes,
