...
const useAccessibility = (componentType, props = {}, context = {}) => {
    const ariaAttributes = useMemo(() => generateAriaAttributes(componentType), [componentType]);
    const keyboardShortcuts = useMemo(() => generateKeyboardShortcuts(componentType, context), [componentType, context]);
    const accessibilityIssues = useMemo(() => validateAccessibility(componentType, props), [componentType, props]);
